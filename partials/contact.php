...
$offices = [
    [
        ...
        "phone"         => "03 6235 0800",
        "fax"           => "03 6235 0888",
        "address"       => "Level 4, 39 Murray Street, Hobart TAS 7000",
        "postal"       => "GPO Box 435, Hobart TAS 7001",
...
<section class="contact-section">
    ...
    <div class="office-card-wrapper">
        <div class="office-card">
            ...
            <?php if(isset($office['postal'])){?><span><strong>GPO Box: </strong><?php echo $office['postal']; ?></span><?php }?>
